...
- **ML projects applied to social networks of politicians.**
...
- **Multiagent Patrolling:** An older Java repository with a simulator and older algorithms for the Multiagent Patrolling Problem (AKA Multi-Robot Patrolling).
...
Feel free to reach out, if you think we can colaborate! 
